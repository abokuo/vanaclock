...
//輸出內容，圖片引用語法依 AJAX 呼叫調整，後續再以 CSS 語法美化呈現
    ...
    echo "<td>曜<br />日</td>";
    echo "<td><img src=\"include/w".$vana_weekday.".gif\" alt=\"".$vara_weekdays[$vana_weekday]."曜日\" title=\"".$vara_weekdays[$vana_weekday]."曜日\" valign=\"middle\"></td>\n";
    echo "<td>月<br />齡</td>";
    echo "<td><img src=\"include/m".$vana_moon_phase.".gif\" alt=\"$vana_moon_phases[$vana_moon_phase]\" title=\"$vana_moon_phases[$vana_moon_phase]\" valign=\"middle\"></td>\n";
    echo "</tr></table>";
    }
